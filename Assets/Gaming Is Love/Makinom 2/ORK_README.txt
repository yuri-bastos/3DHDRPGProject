...
Please see the details in the version comparison found here: https://orkframework.com/download/
...
Please see the details in the version comparison found here: https://makinom.com/download/
...
ORK Framework: https://orkframework.com/guide/

As a first read, I'd recommend to check out the introduction, first steps and game starters documentations:
https://orkframework.com/guide/documentation/getting-started/introduction/
https://orkframework.com/guide/documentation/getting-started/first-steps/
https://orkframework.com/guide/documentation/getting-started/game-starters/

To learn how to set up a status system, follow this tutorial series:
https://orkframework.com/guide/tutorials/status-system-setup/start-status-system-setup/

To learn how to build a game based on a status system, follow this tutorial series:
https://orkframework.com/guide/tutorials/3d-rpg-playground/start-3d-rpg-playground/

If you're seeking information/help with a specific feature, take a look at the documentation:
https://orkframework.com/guide/documentation/
...
https://makinom.com/guide/extensions/
